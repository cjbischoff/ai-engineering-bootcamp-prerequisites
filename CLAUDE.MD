...
- **Merge is separate** — Merge has its own plan; do not include merge steps in the commit plan
...
#### Completing Sprint (Merge Plan — Separate from Commit Plan)
...
- Merge only via Pull Request (merge has its own plan)
